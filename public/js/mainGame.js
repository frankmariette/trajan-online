...
Game.prototype.phaserCreate = function() {
  ...
  var tTile2 = G.phaser.tTiles.create(253, G.phaser.world.height - 968, 'tt_two_cards_blue_orange');
  var tTile3 = G.phaser.tTiles.create(422, G.phaser.world.height - 968, 'tt_move_military_blue_blue');
  var tTile4 = G.phaser.tTiles.create(253, G.phaser.world.height - 884, 'tt_plus_two_pink_white');
  var tTile5 = G.phaser.tTiles.create(422, G.phaser.world.height - 884, 'tt_VP_orange_white');
